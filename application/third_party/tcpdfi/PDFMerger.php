...
class PDFMerger
{
	...
	public function addPDF($filepath, $pages = 'all')
	{
		...
		{
			print_r("Could not locate PDF on '$filepath'");
		}
    ...
    $fpdi->SetPrintFooter(false);
		$fpdi->SetAuthor('HABIB TRIAA');
		//$fpdi->setImageScale(0.1);
		$fpdi->SetProtection(array('modify','copy','print'), "", "", 0, '33');
		//$fpdi->SetProtection(array('modify','copy','print'), "11", "22", 0, '33');
// set array for viewer preferences
		$preferences = array(
			...
			'ViewArea' => '', // CropBox, BleedBox, TrimBox, ArtBox
			'ViewClip' => '', // CropBox, BleedBox, TrimBox, ArtBox
			'PrintArea' => '', // CropBox, BleedBox, TrimBox, ArtBox
			'PrintClip' => '', // CropBox, BleedBox, TrimBox, ArtBox
...
// set pdf viewer preferences
		$fpdi->setViewerPreferences($preferences);
		$fpdi->setOverprint(true);
...
// set pdf viewer preferences
	...
	public function setSourceFile($filepath, $pages = 'all') {
