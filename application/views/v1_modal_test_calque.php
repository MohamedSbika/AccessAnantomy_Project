...
<div id="modalTestCALQUE" class="modal" style="display: none;">
	<div class="modal-content">
		...
		<div class="modal-footer">
			<button type="button" class="btn-secondary btn_test" onclick="closeCustomModalCalque()"><?php echo $this->lang->line('testClose'); ?></button>
			<button type="button" class="btn-primary btn_test" onclick="set_CalqueFigure()"><?php echo $this->lang->line('testBegin'); ?></button>
		</div>
	</div>
</div>
...
<script>
    function closeCustomModalCalque() {
        document.getElementById('modalTestCALQUE').style.display = 'none';
    }
</script>
