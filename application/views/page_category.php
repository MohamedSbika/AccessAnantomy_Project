...
<div class="wrapper">
    ...
    <div class="main"   ondragstart="return false" >
        ...
        <main class="content">
            ...
            <?php foreach ($listCat2 as $value) { ?>
                <?php
                    ...
                    if (stripos($couv, 'pathologie') !== false) {
                        ...
                        elseif ($lang == 'AR') $couv = 'assets/couverture_AR/PR_PATHO_AR.jpg';
                    ...
                    if ($lang == 'RU') {
                        if (stripos($value['Cats']['Libelle'], 'Курс') !== false || stripos($value['Cats']['Libelle'], 'Cours') !== false || stripos($value['Cats']['Libelle'], 'Anatomy-courses') !== false || stripos($value['Cats']['Libelle'], 'Kursy') !== false) $couv = 'assets/couverture_RU/PR_COURSES_RU.jpg';
                        elseif (stripos($value['Cats']['Libelle'], 'Atlas') !== false) $couv = 'assets/couverture_RU/PR_ATLAS_RU.jpg';
                        elseif (stripos($value['Cats']['Libelle'], 'Embr') !== false) $couv = 'assets/couverture_RU/PR_EMBR_RU.jpg';
                    }
                    if ($lang == 'TR') {
                        if (stripos($value['Cats']['Libelle'], 'Dersleri') !== false || stripos($value['Cats']['Libelle'], 'Cours') !== false || stripos($value['Cats']['Libelle'], 'Anatomi-Dersleri') !== false) $couv = 'assets/couverture_TR/PR_COURSES_TR.jpg';
                        elseif (stripos($value['Cats']['Libelle'], 'Atlas') !== false) $couv = 'assets/couverture_TR/PR_ATLAS_TR.jpg';
                        elseif (stripos($value['Cats']['Libelle'], 'Embr') !== false || stripos($value['Cats']['Libelle'], 'Embri') !== false) $couv = 'assets/couverture_TR/PR_EMBR_TR.jpg';
                    }
                    if ($lang == 'PT') {
                    ...
                    if ($lang == 'AR') {
                        if (stripos($value['Cats']['Libelle'], 'دروس التشريح') !== false || stripos($value['Cats']['Libelle'], 'Cours') !== false) $couv = 'assets/couverture_AR/PR_COURSES_AR.jpg';
                        elseif (stripos($value['Cats']['Libelle'], 'أطلس') !== false || stripos($value['Cats']['Libelle'], 'Atlas') !== false) $couv = 'assets/couverture_AR/PR_ATLAS_AR.jpg';
                        elseif (stripos($value['Cats']['Libelle'], 'علم الأجنّة') !== false || stripos($value['Cats']['Libelle'], 'Embr') !== false) $couv = 'assets/couverture_AR/PR_EMBR_AR.jpg';
                    }
                ?>
            ...
            <br>
            <div class="container-fluid " id="setCouv" style="background-color:rgb(144, 203, 185);">
                                ...
                                <div class="containerSo">
                                    <?php
                                        ...
                                        if (stripos($couv2, 'pathologie') !== false) {
                                            ...
                                            elseif ($lang2 == 'AR') $couv2 = 'assets/couverture_AR/PR_PATHO_AR.jpg';
                                        ...
                                        if ($lang2 == 'RU') {
                                            if (stripos($value['Cats']['Libelle'], 'Курс') !== false || stripos($value['Cats']['Libelle'], 'Cours') !== false || stripos($value['Cats']['Libelle'], 'Anatomy-courses') !== false || stripos($value['Cats']['Libelle'], 'Kursy') !== false) $couv2 = 'assets/couverture_RU/PR_COURSES_RU.jpg';
                                            elseif (stripos($value['Cats']['Libelle'], 'Atlas') !== false) $couv2 = 'assets/couverture_RU/PR_ATLAS_RU.jpg';
                                            elseif (stripos($value['Cats']['Libelle'], 'Embr') !== false) $couv2 = 'assets/couverture_RU/PR_EMBR_RU.jpg';
                                        }
                                        if ($lang2 == 'TR') {
                                            if (stripos($value['Cats']['Libelle'], 'Dersleri') !== false || stripos($value['Cats']['Libelle'], 'Cours') !== false || stripos($value['Cats']['Libelle'], 'Anatomi-Dersleri') !== false) $couv2 = 'assets/couverture_TR/PR_COURSES_TR.jpg';
                                            elseif (stripos($value['Cats']['Libelle'], 'Atlas') !== false) $couv2 = 'assets/couverture_TR/PR_ATLAS_TR.jpg';
                                            elseif (stripos($value['Cats']['Libelle'], 'Embr') !== false || stripos($value['Cats']['Libelle'], 'Embri') !== false) $couv2 = 'assets/couverture_TR/PR_EMBR_TR.jpg';
                                        }
                                        if ($lang2 == 'PT') {
                                        ...
                                        if ($lang2 == 'AR') {
                                            if (stripos($value['Cats']['Libelle'], 'دروس التشريح') !== false || stripos($value['Cats']['Libelle'], 'Cours') !== false) $couv2 = 'assets/couverture_AR/PR_COURSES_AR.jpg';
                                            elseif (stripos($value['Cats']['Libelle'], 'أطلس') !== false || stripos($value['Cats']['Libelle'], 'Atlas') !== false) $couv2 = 'assets/couverture_AR/PR_ATLAS_AR.jpg';
                                            elseif (stripos($value['Cats']['Libelle'], 'علم الأجنّة') !== false || stripos($value['Cats']['Libelle'], 'Embr') !== false) $couv2 = 'assets/couverture_AR/PR_EMBR_AR.jpg';
                                        }
                                    ?>
                            ...
                            <?php foreach ($value['items'] as $valItem) { ?>
                                ...
                                <div class="row">
                                    ...
                                    <?php foreach ($valItem['books'] as $valBook) { ?>
                                        <div class="col-12 col-md-6 col-lg-4" style="padding:20px 40px; background:rgb(144, 203, 185); margin-left:auto; margin-right:auto;">
                                            <?php if((strlen($this->session->userdata('passTok'))==200) && ($this->session->userdata('EstAdmin') ==1)) { ?>
                                                <div style="display:flex; flex-direction:row">
                                                    <div class="dropdown " style="padding-left: 1.5em">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <div class="row">
                                                                <div class="col-md-10">
                                                                    <input type="file" name="mFile[]" id="mFile" readonly class="btn btn-info btn-sm" accept="image/png, image/jpeg" >
                                                            ...
                                                            <div class="row">
                                                                <div class="mt-2" style=" text-align: center;">
                                                                    <span class="btn btn-info" onclick="set_Couv()"><i class="fas fa-upload"></i> Upload </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <a href="#descBKL_<?php print $valBook['IDLivre']; ?>" data-toggle="modal" data-target="#descBKL_<?php print $valBook['IDLivre']; ?>"
                                               class="list-group-item" style="border: white;padding: 30px;">
