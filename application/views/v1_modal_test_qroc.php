...
<div id="modalTestQROC" class="modal" style="display: none;">
	<div class="modal-content">
				...
				<div>
					<form name="pageForm_TestQROC" id="pageForm_TestQROC" action="">
						<input type="hidden" name="bookID" id="bookID" value="<?= base64_encode($OneBook[0]['IDLivre']); ?>">
						 <input type="hidden" name="typeQCM" value="3">
		...
		<div class="modal-footer">
			<button type="button" class="btn-secondary btn_test" onclick="closeCustomModalQroc()"><?php echo $this->lang->line('testClose'); ?></button>
			<button type="button" class="btn-primary btn_test" onclick="set_testQrocChap()"><?php echo $this->lang->line('testBegin'); ?></button>
		</div>
	</div>
</div>
...
<script>
    function closeCustomModalQroc() {
        document.getElementById('modalTestQROC').style.display = 'none';
    }
</script>
