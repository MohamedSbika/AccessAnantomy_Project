		...
		<div class="col-12 col-lg-6 col-xl-6">
			...
			<div class="card" style="height: 100%;">
				<div class="card-header">
					<div class="row">
						<li class="breadcrumb-item"><a href="<?php echo base_url(); ?><?php echo $this->lang->line('siteLang'); ?>livreDetails/<?php print $OneBook[0]["IDLivre"]; ?>">Chapitres</a>
						<a class="badge bg-success text-white ml-2" id="go-button" href="#" style="float:right; background-color: #8f84d9 !important;"><i class="fa fa-window-maximize" aria-hidden="true"></i></a></li>
					</div>
...
<script type='text/javascript'>
	...
	$(document).ready(function () {
		...
		Swal.fire({
			title: "L'affichage sera en plein d'écran",
