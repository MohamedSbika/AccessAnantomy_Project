            ...
            <main class="content">
                                    ...
                                    foreach ($arrayFigures as $figure) {
                                        ...
                                        if ($compteurFigure === 0) {
                                            ...
                                            <?php } $compteurFigure++; ?>
                                                     ...
                                                     <img style="display:block;margin:auto;" src="data:image/png;base64,<?php print $figure['image'] ?> "></img>
                ...
                <section>
                    ...
                    ?>
                            ...
                            <div class="container block-figure">
                            <?php } else { ?>
                                <div class="container block-figure inactive">
                                <?php }
                            $compteurFigure++; ?>


                                <div class="row">
                                    <div class="col-sm-12" style="margin:20px; margin-left:auto; margin-right:auto;">
                                       <h1 style="text-align:center; text-decoration: underline black;"> Test : <?= $compteurFigure; ?></h1>
                                    </div>
                                </div>
    ...
    <script>
        ...
        var afficheFigure = function(position) {
            ...
            for(let i = 0; i < figures.length; i++){
                if(i == position){
                    figures[i].setAttribute("class", "container block-figure")
                    buttons[i].setAttribute("class", "image-figure selected-figure")
                    
                }else{
                    figures[i].setAttribute("class", "container block-figure inactive")
