			...
			<main class="content">
				...
				<style>
					...
					.btn_app{
						...
						height: 35px;
						background: linear-gradient(135deg, #ffffffff, #457b9d);
						color: white;
						font-weight: bold;
					}
				</style>
						...
						<div class="content block-figure inactive">
							...
							<div class="row">
								<div class="col-sm-4" style="margin-top: 20px; display: flex;justify-content: center; align-items: center;text-align: end; gap: 40px;">
									<button class="btn-info btn_app"  onclick="location.reload();"><?php echo $this->lang->line('sidebar_ap_tooltip'); ?></button>
								</div>
								...
								<div class="col-sm-4" style="margin-top:20px; display:flex; justify-content:center; align-items:center;">
									<button class="btn-info btn_app beginTest"><?php echo $this->lang->line('test_legendes'); ?></button>
								</div>
