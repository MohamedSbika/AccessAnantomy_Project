...
background: linear-gradient(135deg, #120E47 30%, #ffffffff 100%);">
	...
	<script type="text/javascript" >
        ...
        function setFCS(id=0){
            var kpp 		= "setInf-"+id;
            var inputZZ = document.getElementById(kpp);
            inputZZ.focus();
        }
        ...
        function myFunction(id=0) {
            ...
            {
                elmsResp[i].style.visibility = 'hidden';
            }
        }
        function myFunction___(id=0) {
            ...
            Swal.fire({
                title				: "Résultat"+'<br>'+"Vous avez obtenu "+'<br>'+nbrQ+"/"+nbrQR,
                position			: 'center',
                type				: 'success',
