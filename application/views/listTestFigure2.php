...
<body oncontextmenu="return false" onbeforeprint="return false" onselectstart="return false" ondragstart="return false">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <div class="row" style="margin-top:20px; position:relative; padding-left:15px;">
                                            <hr>
                                            <button style="padding:0px; right:0px; position:absolute; width:50%; height:100%;" class="btn btn-success btn-corriger btn-<?= $compteurFigure; ?>" onclick="afficheReponseBlock('btn-<?= $compteurFigure; ?>')"> <?php echo $this->lang->line('decouv_respons'); ?> </button>
                                    ...
                                    <div class="col-sm-4" style="position:relative; margin-top:20px">
                                        <img style="display:block;margin:auto; max-width:100%;" src="data:image/png;base64,<?php print $figure['image'] ?> "></img>
                                    </div>
                                    <div class="col-sm-4">
                                       
                                            <div class="row" style="margin-top:20px; position:relative; padding-right:15px;">
                                                <hr>

                                                <button style="padding:0px; left:0px; position:absolute; width:50%; height:100%;" class="btn btn-success btn-corriger  btn-<?= $compteurFigure; ?>" onclick="afficheReponseBlock('btn-<?= $compteurFigure; ?>')"> <?php echo $this->lang->line('decouv_respons'); ?> </button>
                                    ...
                                    <div class="col-sm-6" style="margin:20px; margin-left:auto; margin-right:auto;">
                                        <div class="row">
                                            ...
                                            <div class="col-12" style="position:relative; padding-left:0px; padding-right:0px; min-height:30px;">
                                                <button style="padding:0px; float:right; position:absolute; width:100%; height:100%;" class="btn btn-success btn-corriger btn-<?= $compteurFigure; ?>" onclick="afficheReponseBlock('btn-<?= $compteurFigure; ?>')"> <?php echo $this->lang->line('decouv_respons'); ?> </button>
    ...
    <script>
        ...
        var afficheReponseBlock = function(classR) {
            var buttons = document.getElementsByClassName(classR);
