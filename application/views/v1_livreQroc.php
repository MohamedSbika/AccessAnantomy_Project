...
background: linear-gradient(135deg, #120E47 30%, #182540 100%);">
    ...
    <style>
        ...
        * {
        ...
        /* Conteneur principal */
            ...
            align-items: flex-start;   /* important pour aligner les 2 blocs */
            height: auto;              /* override du 200px plus haut */
        }

        /* Colonnes Bootstrap utilisées comme blocs */
        .col-12.col-lg-6.col-xl-6 {
            display: flex;
            flex-direction: column;
            float: none !important;     /* override des inline styles float */
        }

        .col-12.col-lg-6.col-xl-6 .row {
            flex: 1;
            display: flex;
            flex-direction: column;
            height: 100%;
        ...
        /* Optionnel : pour laisser le tableau occuper la largeur */
        #datatables-ajax {
            width: 100%;
        }

        /* Colonne gauche spécifique */
        .left-qroc {
            /* garde ton style de largeur avec le inline, juste sans float */
        }

        /* Colonne droite spécifique */
        .right-figures {
            /* idem, on garde la largeur inline */
        }
    ...
    <div id="element">
        ...
        <!-- COLONNE GAUCHE QROC -->
        <div class="col-12 col-lg-6 col-xl-6 left-qroc" style="width: 46%;margin-left: 75px; margin-top: 20px;">
            <div class="row">
        ...
        <!-- COLONNE DROITE FIGURES -->
        <div class="col-12 col-lg-6 col-xl-6 right-figures" style="width: 48%;">
    ...
    <style>
        ...
        .dataTables_paginate {
            ...
            margin-top: 1px;           /* Optional: adds space above the pagination */
            padding-bottom: 1px;       /* Optional: adds space above the pagination */
            overflow-x: auto;
        ...
        .paginate_button.page-item.current {
            ...
            border-radius: .2rem;
			padding: 12px 12px;		/* Padding for the button */
