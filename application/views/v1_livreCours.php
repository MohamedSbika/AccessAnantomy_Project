<?php if(strlen($this->session->userdata('passTok'))==200) { ?>
	...
	<head>
		...
		<style type="text/css">
			...
			/* Media queries pour responsive design optimisé */
...
background: linear-gradient(135deg, #120E47 30%, #182540 100%);">
	...
	<style>
		...
		* {
		...
		/* Colonne gauche - Réduction de width */
		.left-column {
			flex: 1 1 100%;
			max-width: 100%;
			margin-bottom: 15px;
		...
		/* Colonne droite - Réduction de width */
		.right-column {
			flex: 1 1 100%;
			max-width: 100%;
		}
		...
		/* Ajustements supplémentaires pour les colonnes */
