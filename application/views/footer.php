...
<footer class="footer">
    <section style="background-color: rgb(25, 73, 110); overflow-x:hidden !important; padding:10px 0px;">

        <div class="content">
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                <!-- Logo et Réseaux sociaux -->
                <div class="col-12 col-md-4 my-3 text-center text-md-left">
                    <img src="<?php echo HTTP_IMAGES; ?>icons/icon-logo.png" class="mb-3" style="margin: 5px;">
                    <div class="socials d-flex justify-content-center justify-content-md-start align-items-center" style="padding-left: 0.5rem;">
                        <!-- Facebook -->
                        <a href="<?= $this->session->userdata('social_facebook') ?: '#'; ?>"
                           target="_blank"
                           class="social-link"
                        ...
                        <!-- Instagram -->
                        <a href="<?= $this->session->userdata('social_instagram') ?: '#'; ?>"
                           target="_blank"
                           class="social-link"
                        ...
                        <!-- Twitter -->
                        <a href="<?= $this->session->userdata('social_twitter') ?: '#'; ?>"
                           target="_blank"
                           class="social-link"
                           style="display: <?= $this->session->userdata('social_twitter') ? 'flex' : 'none'; ?>;">
                            <img src="<?php echo HTTP_IMAGES; ?>social_media/twitter_40.png" class="rounded-circle social-icon" alt="Twitter">
                        </a>
                        <!-- LinkedIn -->
                        <a href="<?= $this->session->userdata('social_linkedin') ?: '#'; ?>"
                           target="_blank"
                           class="social-link"
                           style="display: <?= $this->session->userdata('social_linkedin') ? 'flex' : 'none'; ?>;">
                            <img src="<?php echo HTTP_IMAGES; ?>social_media/linkedin.png" class="rounded-circle social-icon" alt="LinkedIn">
                        </a>
                        <!-- YouTube -->
                        <a href="<?= $this->session->userdata('social_youtube') ?: '#'; ?>"
                           target="_blank"
                           class="social-link"
                           style="display: <?= $this->session->userdata('social_youtube') ? 'flex' : 'none'; ?>;">
                            <img src="<?php echo HTTP_IMAGES; ?>social_media/youtube_40.png" class="rounded-circle social-icon" alt="YouTube">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4 text-center my-3 my-md-0">
        				<span class="connecte-span" style="float: inherit;"
                              onclick="window.location.href='<?php echo base_url() . $this->lang->line('siteLang'); ?>contactUS';">
            				Contact
        				</span>
                </div>
            ...
            <div class="col-12" style="margin-left: 5px;text-align: center;">
                <p class="mb-0">
                    <a href="https://www.bongest.net" target="_blank" style="color: white; text-decoration: none;">
                        <strong>© 2024 Access Anatomy. All rights reserved - Powered By BonGest</strong>
                    </a>
                </p>
            </div>
    </section>
