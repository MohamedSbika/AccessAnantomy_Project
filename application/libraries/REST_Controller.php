...
abstract class REST_Controller extends CI_Controller {
    ...
    protected function _check_php_session()
    {
        ...
        if ( ! $this->session->userdata($key))
        {
            ...
            $this->response([
                $this->config->item('rest_status_field_name') => FALSE,
                $this->config->item('rest_message_field_name') => $this->lang->line('text_rest_unauthorized')."_check_php_session"
            ], self::HTTP_UNAUTHORIZED);
        }
    }
    ...
    protected function _force_login($nonce = '')
    {
        ...
        $this->response([
            $this->config->item('rest_status_field_name') => FALSE,
            $this->config->item('rest_message_field_name') => $this->lang->line('text_rest_unauthorized')."_force_login"
        ], self::HTTP_UNAUTHORIZED);
    }
